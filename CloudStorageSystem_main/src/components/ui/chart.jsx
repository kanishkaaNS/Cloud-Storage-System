...
function ChartContainer({ id, className, children, config, ...props }, , { config: ChartConfig, children, ["children"]:  }) {
...
function ChartTooltipContent({ active, payload, className, indicator = "dot", hideLabel = false, hideIndicator = false, label, labelFormatter, labelClassName, formatter, color, nameKey, labelKey, }, , React, ComponentProps, , ) { }
 >  & {
    hideLabel,
    hideIndicator,
...
function ChartLegendContent({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey, }, , Pick, , RechartsPrimitive, LegendProps, , , ) { }
 >  & {
    hideIcon,
    nameKey
};
