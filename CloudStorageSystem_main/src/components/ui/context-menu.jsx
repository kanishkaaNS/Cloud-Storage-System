...
function ContextMenuSubTrigger({ className, inset, children, ...props }, , { inset }) {
...
function ContextMenuItem({ className, inset, variant = "default", ...props }, , { inset }, variant) {
...
function ContextMenuLabel({ className, inset, ...props }, , { inset }) {
