...
function DropdownMenuItem({ className, inset, variant = "default", ...props }, , { inset }, variant) {
...
function DropdownMenuLabel({ className, inset, ...props }, , { inset }) {
...
function DropdownMenuSubTrigger({ className, inset, children, ...props }, , { inset }) {
