...
function MenubarItem({ className, inset, variant = "default", ...props }, , { inset }, variant) {
...
function MenubarLabel({ className, inset, ...props }, , { inset }) {
...
function MenubarSubTrigger({ className, inset, children, ...props }, , { inset }) {
