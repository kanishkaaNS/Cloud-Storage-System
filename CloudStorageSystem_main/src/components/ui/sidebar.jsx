...
function SidebarMenuButton({ asChild = false, variant = "default", size = "default", tooltip, isActive, className, ...props }) {
    const Comp = asChild ? Slot : "button";
    ...
    const { Tooltip, TooltipContent, TooltipTrigger } = require("./tooltip");
    return (<Tooltip>
